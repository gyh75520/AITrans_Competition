...
def test(model,Env):
    # path setting
    # TRAIN_TRACES = './new_network/zhongwang4test/'   #train trace path setting,
    # TRAIN_TRACES = './new_network/ruowang4test/'   #train trace path setting,
    # TRAIN_TRACES = './new_network/qiangwang4test/'   #train trace path setting,
    TRAIN_TRACES = './network_meter4test/'   #train trace path setting,


    #video_size_file = './video_trace/AsianCup_China_Uzbekistan/frame_trace_'      #video trace path setting,
    video_size_file = './video_trace/12-16/video_trace/frame_trace_'      #video trace path setting,
