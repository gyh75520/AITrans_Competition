...
video_size_file = './video_trace/12-13/video_trace/frame_trace_'      #video trace path setting,
...
while True:
        ...
        time, time_interval, send_data_size, chunk_len, rebuf, buffer_size, end_delay, \
        cdn_newest_id, downlaod_id, cdn_has_frame, decision_flag, buffer_flag,\
        switch, cdn_flag, end_of_video = net_env.get_video_frame(bit_rate,target_buffer)
        cnt += 1
